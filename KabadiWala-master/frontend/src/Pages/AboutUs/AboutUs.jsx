    ...
    <div className="aboutUs-container">
      <header className="aboutUs-header">
        ...
        <p className="welcome-text">
          Welcome to Scrap Baba Sell Scrap Online
        </p>
      </header>
      ...
      <section className="about-section">
        <p>
        Scrap Baba, co-founded by the innovative team at <strong>WasteWizard</strong>, is proud to lead the way in revolutionizing online recycling and waste management.
        </p>
        <p>
      ...
      <section className="vision-mission-goal">
        ...
        <div className="card">
          <h3>Goal</h3>
          <p>
            Our goal is to establish Kabadiwala as the go-to platform for
